...
public class TESTARTICOLOMULTI {
...
//        double[] a= prova(ds2Times,normal_model_test,new String[]{"x","y"});
//        double[] b= prova(ds2Times,ineffective_model_test,new String[]{"x","y"});
...
//            GeneticOptions.init__until_weight=0.9;
          ...
          //  pop.generateInitialPopulation();
            ...
            for (int i = pop.getPopulationSize(); i <60 ; i++) {
