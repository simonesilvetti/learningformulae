...
public class TestGPUCB {

    public static void main(String[] args) {
        GeneticOptions.setMax_time_bound(2);
        ...
        //double[] vv = new double[]{0.3, 0.8, 200};
        double[] vv = new double[]{0.3, 0.8, -200,200};
...
//        }
        ...
        continuousOptimization(pop, formula, normal_model, ineffective_model, Tf, 2000);
        double[] p1u1 = smc(pop, formula, normal_model, Tf, 2000);
        double[] p2u2 = smc(pop, formula, ineffective_model, Tf, 2000);
