...
import static com.eggloop.flow.simhya.simhya.matlab.TestFinal.smcAverage;

public class TESTARTICOLO {
    public static void main(String[] args) {
        Random ran = new Random(1);
        // it reads data and builds the matrix, maybe each row is a path
        ...
        // N number of starting formula
        int N = 10;

        // crossOver algo gen (probability to switch two nodes)
        double crossoverProbability = 0.9;
        double migrationProbability = 0.0;
        // number of parents (== to the number of starting formula)
        int numParents = N;
